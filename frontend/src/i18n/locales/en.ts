export default {
  ...
  keys: {
    ...
    useKeyModal: {
      ...
      openclaw: {
        description: 'Write the following config into your OpenClaw config file to use this API key.',
        note: 'If ~/.openclaw/openclaw.json already exists, back it up first and merge instead of overwriting your existing providers.',
        hint: 'Recommended: back up your current config, then merge this provider under models.providers.',
      },
    },
  ...
  distribution: {
    title: 'Distribution',
    description: 'Manage your invite code, team, commissions and withdrawals',
    inviteCode: 'Invite Code',
    inviterUserId: 'Inviter User ID',
    unbound: 'Unbound',
    bindInviteCode: 'Bind Inviter',
    bindPlaceholder: 'Enter inviter invite code',
    bindButton: 'Bind',
    binding: 'Binding...',
    bindSuccess: 'Inviter bound successfully',
    ...
    withdrawalTitle: 'Create Withdrawal Request',
    amount: 'Amount',
    ...
    withdrawalSuccess: 'Withdrawal request created',
    channelStats: 'Channel Conversion Mix',
    weeklyGoals: 'Weekly Goals',
    goalReferrals: 'New Referrals',
    goalContribution: 'Team Contribution Target',
    goalWithdrawable: 'Withdrawable Target',
    promoKit: 'Promotion Kit',
    copyWeChatPitch: 'Copy DM Pitch',
    copyGroupPitch: 'Copy Group Pitch',
    copyInviteLink: 'Copy Invite Link',
    copySuccess: 'Copied to clipboard',
    wechatPitchTemplate: 'Hi! I am using Sub2API to distribute AI services. Here is my invite link: {link}. You can get started quickly after signup, and I can assist you one-on-one.',
    groupPitchTemplate: 'Hey everyone, sharing an AI distribution platform I use: Sub2API. Signup link: {link}. It supports referral commissions and team management.',
    referralsTitle: 'Direct Referrals',
    teamTitle: 'Team Members',
    commissionsTitle: 'Commission Records',
    all: 'All',
    withdrawalsTitle: 'Withdrawal Records',
    noData: 'No data',
