...
describe('distributionWithdrawalError', () => {
  ...
  it('extracts reason when backend returns plain string error code', () => {
    ...
    expect(extractDistributionWithdrawalReason({ error: 'DISTRIBUTION_WITHDRAWAL_DAILY_LIMIT' }))
      .toBe('DISTRIBUTION_WITHDRAWAL_DAILY_LIMIT')
    expect(extractDistributionWithdrawalReason({ error: 'DISTRIBUTION_WITHDRAWAL_DAILY_AMOUNT_LIMIT' }))
      .toBe('DISTRIBUTION_WITHDRAWAL_DAILY_AMOUNT_LIMIT')
    expect(extractDistributionWithdrawalReason({ data: { error: 'DISTRIBUTION_WITHDRAWAL_DAILY_LIMIT' } }))
      .toBe('DISTRIBUTION_WITHDRAWAL_DAILY_LIMIT')
    expect(extractDistributionWithdrawalReason({ response: { data: { error: 'DISTRIBUTION_WITHDRAWAL_DAILY_LIMIT_AMOUNT' } } }))
      .toBe('DISTRIBUTION_WITHDRAWAL_DAILY_AMOUNT_LIMIT')
