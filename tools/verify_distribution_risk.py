...
def static_verify() -> list[str]:
    ...
    require_all(
        ...
        [
            ...
            ("error: { reason: 'distribution_withdrawal_daily_limit_count' }", "P1 reason extractor spec covers top-level error.reason daily-count alias envelope"),
            ...
            ("error: 'DISTRIBUTION_WITHDRAWAL_COOLDOWN'", "P1 reason extractor spec covers top-level uppercase error string envelope for cooldown"),
            ("error: 'DISTRIBUTION_WITHDRAWAL_DAILY_LIMIT'", "P1 reason extractor spec covers top-level uppercase error string envelope for canonical daily-count code"),
            ("error: 'DISTRIBUTION_WITHDRAWAL_DAILY_AMOUNT_LIMIT'", "P1 reason extractor spec covers top-level uppercase error string envelope for daily-amount code"),
            ("data: { error: 'DISTRIBUTION_WITHDRAWAL_DAILY_LIMIT' }", "P1 reason extractor spec covers top-level data.error uppercase string envelope for canonical daily-count code"),
            ("response: { data: { error: 'DISTRIBUTION_WITHDRAWAL_DAILY_LIMIT_AMOUNT' } }", "P1 reason extractor spec covers response.data.error uppercase string envelope for daily-amount code"),
            ("code: 'distribution_withdrawal_daily_limit'", "P1 reason extractor spec covers canonical daily-count code in code envelopes"),
            ("reason: 'distribution_withdrawal_cooldown'", "P1 reason extractor spec covers top-level reason payload shape for cooldown"),
            ("reason: 'distribution_withdrawal_daily_limit'", "P1 reason extractor spec covers top-level reason payload shape for canonical daily-count code"),
            ("reason: 'distribution_withdrawal_daily_limit_count'", "P1 reason extractor spec covers top-level reason payload shape for daily-count alias"),
            ("reason: 'distribution_withdrawal_daily_limit_amount'", "P1 reason extractor spec covers top-level reason payload shape for daily-amount"),
            ("reason: 'DISTRIBUTION_WITHDRAWAL_DAILY_AMOUNT_LIMIT'", "P1 reason extractor spec covers top-level uppercase reason payload shape for daily-amount"),
            ...
            ("error: { message: 'request rejected: distribution_withdrawal_cooldown' }", "P1 reason extractor spec covers top-level error.message token fallback for cooldown"),
    ...
    require_all(
        ...
        [
            ...
            ("code: 'distribution_withdrawal_daily_limit'", "P1 locale-message spec covers top-level code payload shape for canonical daily-count code"),
            ("code: 'DISTRIBUTION_WITHDRAWAL_COOLDOWN'", "P1 locale-message spec covers top-level uppercase code payload shape for cooldown"),
            ("code: 'DISTRIBUTION_WITHDRAWAL_DAILY_LIMIT'", "P1 locale-message spec covers top-level uppercase code payload shape for canonical daily-count code"),
            ("code: 'DISTRIBUTION_WITHDRAWAL_DAILY_AMOUNT_LIMIT'", "P1 locale-message spec covers top-level uppercase code payload shape for daily-amount"),
            ...
            ("error: { code: 'distribution_withdrawal_cooldown' }", "P1 locale-message spec covers top-level error.code payload shape for cooldown"),
            ...
            ("error: { code: 'DISTRIBUTION_WITHDRAWAL_COOLDOWN' }", "P1 locale-message spec covers top-level uppercase error.code payload shape for cooldown"),
            ("error: { code: 'DISTRIBUTION_WITHDRAWAL_DAILY_LIMIT' }", "P1 locale-message spec covers top-level uppercase error.code payload shape for canonical daily-count code"),
            ("error: { code: 'DISTRIBUTION_WITHDRAWAL_DAILY_AMOUNT_LIMIT' }", "P1 locale-message spec covers top-level uppercase error.code payload shape for daily-amount"),
            ...
            ("error: { reason: 'distribution_withdrawal_daily_limit_count' }", "P1 locale-message spec covers top-level error.reason payload shape for daily-count alias code"),
            ...
            ("error: { reason: 'DISTRIBUTION_WITHDRAWAL_COOLDOWN' }", "P1 locale-message spec covers top-level uppercase error.reason payload shape for cooldown"),
            ("error: { reason: 'DISTRIBUTION_WITHDRAWAL_DAILY_LIMIT' }", "P1 locale-message spec covers top-level uppercase error.reason payload shape for canonical daily-count code"),
            ("error: { reason: 'DISTRIBUTION_WITHDRAWAL_DAILY_AMOUNT_LIMIT' }", "P1 locale-message spec covers top-level uppercase error.reason payload shape for daily-amount"),
            ...
            ("error: 'DISTRIBUTION_WITHDRAWAL_COOLDOWN'", "P1 locale-message spec covers top-level uppercase error string payload for cooldown"),
            ("error: 'DISTRIBUTION_WITHDRAWAL_DAILY_LIMIT'", "P1 locale-message spec covers top-level uppercase error string payload for canonical daily-count code"),
            ("error: 'DISTRIBUTION_WITHDRAWAL_DAILY_AMOUNT_LIMIT'", "P1 locale-message spec covers top-level uppercase error string payload for daily-amount"),
            ("data: { error: 'DISTRIBUTION_WITHDRAWAL_DAILY_LIMIT' }", "P1 locale-message spec covers top-level data.error uppercase string payload for canonical daily-count code"),
            ("response: { data: { error: 'DISTRIBUTION_WITHDRAWAL_DAILY_LIMIT_AMOUNT' } }", "P1 locale-message spec covers response.data.error uppercase string payload for daily-amount"),
            ...
            ("error: { message: 'request blocked: distribution_withdrawal_cooldown' }", "P1 locale-message spec covers top-level error.message payload shape for cooldown token"),
