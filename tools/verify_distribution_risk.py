...
def static_verify() -> list[str]:
    ...
    require_all(
        ...
        [
            ...
            ("data: { error: 'distribution_withdrawal_daily_limit_count' }", "P1 locale-message spec covers top-level data.error string payload for daily-count"),
            ...
            ("response: { data: { error: 'distribution_withdrawal_daily_limit_count' } }", "P1 locale-message spec covers response.data.error string payload for daily-count"),
