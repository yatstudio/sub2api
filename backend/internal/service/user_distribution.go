...
var (
	...
	ErrDistributionWithdrawalAccountRefTooLong   = infraerrors.BadRequest("DISTRIBUTION_WITHDRAWAL_ACCOUNT_REF_TOO_LONG", "withdrawal account reference is too long")
	ErrDistributionWithdrawalNotesTooLong        = infraerrors.BadRequest("DISTRIBUTION_WITHDRAWAL_NOTES_TOO_LONG", "withdrawal notes are too long")
